class AuthErrorTranslator {
  static const Map<String, String> errorCodeMap = {
    ...
    "auth/invalid-persistence": "Invalid persistence type",
    ...
    "auth/unsupported-persistence": "Unsupported persistence type",
  ...
  static String? getErrorDescription(String errorCode) {
    for (var key in errorCodeMap.keys) {
